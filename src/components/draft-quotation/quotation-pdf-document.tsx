  ...
  return (
    <Page size="A4" style={styles.page}>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.table}>
          ...
          <View style={styles.tableRow}>
            <Text style={styles.tableCell}>Monto a enviar ({currency})</Text>
      ...
      <View style={styles.conditions}>
        <Text style={styles.conditionsTitle}>CONDICIONES DE LA OPERACIÓN</Text>
        <Text style={styles.conditionsText}>
          1. La presente cotización tiene una validez de 24 horas a partir de su
          emisión, debido a la variación constante del tipo de cambio y costos
          asociados. La operación será ejecutada en un plazo de hasta un (1) día
          hábil contado desde la confirmación del depósito íntegro del monto
          total cotizado, el cual deberá realizarse exclusivamente mediante
          transferencia bancaria a la cuenta empresarial de NORDEX GLOBAL SRL.
          {"\n\n"}
