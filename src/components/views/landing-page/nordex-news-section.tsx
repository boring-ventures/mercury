        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-12">
          ...
          <div className="space-y-6">
            {news.slice(1).map((article) => (
              <div
                key={article.id}
                className="bg-white rounded-xl p-6 hover:shadow-lg transition-all duration-300 group border border-gray-100"
              >
                <div className="space-y-4">
          ...
          <div className="text-center space-y-6">
            <div className="space-y-3">
              ...
              <p className="text-[#1F1915A3] text-sm md:text-base max-w-2xl mx-auto">
                Recibe las últimas noticias, insights del mercado y consejos
                exclusivos para hacer crecer tu negocio internacionalmente.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              ...
              />
              <Button className="bg-[#051D67] hover:bg-[#041655] text-white px-6 py-3 rounded-md font-medium transition-all duration-200 whitespace-nowrap">
                Suscribirse
              </Button>
            </div>
